...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
    ...
    if(check_bitrix_sessid())
    {
        ...
        foreach ($arParams['REQUIRED_FIELDS'] as $key)
        {
            ...
            {
                $arResult["ERROR_MESSAGE"][] = GetMessage("MF_REQ").'"'.$arParams['FIELDS_NAME'][$key].'".';
            }
            if ($key == 'EMAIL' && !check_email($arFs[$key]))
            {
                $arResult["ERROR_MESSAGE"][] = GetMessage("MF_WRONG").' "'.$arParams['FIELDS_NAME'][$key].'".';
            }
        }
        foreach ($arParams['FIELDS'] as $key)
        {
        ...
        if(empty($arResult["ERROR_MESSAGE"]))
        {
            ...
            $arFieldsElem = array(
                ...
                "NAME"=>GetMessage("MF_NEW_ELEMENT"),
